 ...
 */
#ifndef ANALYSIS_PAOSELECTION_DOIBASEDSELECTER_H_
#define ANALYSIS_PAOSELECTION_DOIBASEDSELECTER_H_
...
/**
 * @class DOIBasedSelecter DOIBasedSelecter.h
 ...
 */
class DOIBasedSelecter : public PAOSelecter {
 public:
  /**
   ...
   */
  DOIBasedSelecter(std::shared_ptr<Eigen::MatrixXd> occupiedCoefficients, std::shared_ptr<PAOController> paoController,
                   std::shared_ptr<BasisFunctionOnGridController> basOnGridController,
                   std::shared_ptr<AtomCenteredBasisController> atomCenteredBasisController, double doiThreshold,
                   double mnpPreThreshold)
    : _occupiedCoefficients(occupiedCoefficients),
      ...
      _doiThreshold(doiThreshold),
      _mnpPreThreshold(mnpPreThreshold){};
  /**
   * @brief Default destructor.
   */
  virtual ~DOIBasedSelecter() = default;
...
#endif /* ANALYSIS_PAOSELECTION_DOIBASEDSELECTER_H_ */
