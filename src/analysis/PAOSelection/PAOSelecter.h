...
#ifndef ANALYSIS_PAOSELECTION_PAOSELECTER_H_
#define ANALYSIS_PAOSELECTION_PAOSELECTER_H_
...
namespace Serenity {
/**
 * @class PAOSelecter PAOSelecter.h
...
#endif /* ANALYSIS_PAOSELECTION_PAOSELECTER_H_ */
