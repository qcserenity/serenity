 ...
 *        configuration
 */
template<Options::SCF_MODES SCFMode>class ELFCalculator {
public:
  ELFCalculator(
 ...
 *        This function must be given the gridController of the respective grid on which the kinetic energy density is to be
 *        calculated.
...
private:
  ...
  std::shared_ptr<AtomCenteredBasisController> _basisController =_systemController->
