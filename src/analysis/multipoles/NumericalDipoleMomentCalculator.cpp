...
Eigen::Vector3d NumericalDipoleMomentCalculator::calculateDipoleMoment(
    ...
    auto densityOnGrid =
      densityOnGridCalculator->calcDensityOnGrid(
          system->getElectronicStructure<SCFMode>()->getDensityMatrix());
...
NumericalDipoleMomentCalculator::calculateDipoleMoment<Options::SCF_MODES::RESTRICTED>(
    std::shared_ptr<SystemController> system);
template Eigen::Vector3d
NumericalDipoleMomentCalculator::calculateDipoleMoment<Options::SCF_MODES::UNRESTRICTED>(
    std::shared_ptr<SystemController> system);
