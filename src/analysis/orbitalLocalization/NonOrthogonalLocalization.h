...
template<Options::SCF_MODES T>class NonOrthogonalLocalization : public Localization<T> {
public:
   ...
   */
  virtual void localizeOrbitals(OrbitalController<T>& orbitals,
...
private:
   ...
   * @param maxSweeps
   */
  void doLocalization(Eigen::MatrixXd& coefficients, unsigned int nOccOrbs,
