 ...
 */
template<Options::SCF_MODES SCFMode>class PipekMezeyLocalization : public Localization<SCFMode> {
public:
  /**
   * @brief Constructor
   ...
   */
  void localizeOrbitals(OrbitalController<SCFMode>& orbitals,unsigned int maxSweeps) override final;
