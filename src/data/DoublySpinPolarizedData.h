 ...
 */
template<Options::SCF_MODES T, class U, typename E=void>class DoublySpinPolarizedData;
/**
 * Restricted, non-primitives
 */
template<class U>
class DoublySpinPolarizedData<
    Options::SCF_MODES::RESTRICTED,
    U,
...
public:
  inline explicit DoublySpinPolarizedData(
    DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>&) = default;
  inline explicit DoublySpinPolarizedData(
    const DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>&) = default;
  inline DoublySpinPolarizedData(
    DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>&&) = default;
  ...
  inline DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>& operator=(
      const DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>& orig) = default;
  inline DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>& operator=(
      DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, U, void>&& orig) = default;
  /*
   * Forward constructors of a single U-type object. I looked at std::make_shared for this.
   */
  template<typename... _Args>inline DoublySpinPolarizedData(_Args&&... __args) :
    DoublySpinPolarizedData(std::piecewise_construct,
          U(std::forward<_Args>(__args)...),
          U(std::forward<_Args>(__args)...),
          U(std::forward<_Args>(__args)...),
          U(std::forward<_Args>(__args)...)) {}
  U aa;
...
public:
  ...
  inline DoublySpinPolarizedData(
    DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, GridData<RESTRICTED>, void>&&) = default;
  inline DoublySpinPolarizedData(std::piecewise_construct_t, GridData<RESTRICTED>&& aa_,
                                                             GridData<RESTRICTED>&& ab_,
                                                             GridData<RESTRICTED>&& ba_,
                                                             GridData<RESTRICTED>&& bb_) :
      aa(std::move(aa_)), ab(std::move(ab_)), ba(std::move(ba_)), bb(std::move(bb_)) {}

  inline DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, GridData<RESTRICTED>, void>& operator=(
      const DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, GridData<RESTRICTED>, void>& orig) = default;
  inline DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, GridData<RESTRICTED>, void>& operator=(
      DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, GridData<RESTRICTED>, void>&& orig) = default;
  /*
   * Forward constructors of a single U-type object. I looked at std::make_shared for this.
   */
  template<typename... _Args>inline DoublySpinPolarizedData(_Args&&... __args) :
...
template<class T, class X>void apply(
    DoublySpinPolarizedData<Options::SCF_MODES::RESTRICTED, T>& target, X func) {
  func(target);
}
template<class T, class X>void apply(
    const DoublySpinPolarizedData<Options::SCF_MODES::RESTRICTED, T>& target, X func) {
  func(target);
}
template<class T, class X>void apply(
    DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, T>& target, X func) {
  func(target.aa);
  func(target.ab);
  func(target.ba);
  func(target.bb);
...
template<class T, class X>void apply(
    const DoublySpinPolarizedData<Options::SCF_MODES::UNRESTRICTED, T>& target, X func) {
  func(target.aa);
  func(target.ab);
  func(target.ba);
  func(target.bb);
