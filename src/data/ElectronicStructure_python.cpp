...
void export_ElectronicStructure(py::module &spy) {
  py::class_<ElectronicStructure<Options::SCF_MODES::RESTRICTED>,
           std::shared_ptr<ElectronicStructure<Options::SCF_MODES::RESTRICTED> > >(spy,
               "ElectronicStructure_R",
        "@brief A restricted electronic structure.")
        ...
        .def("orbEn",&orbEn)
        .def("fock",&fock);
  py::class_<ElectronicStructure<Options::SCF_MODES::UNRESTRICTED>,
           std::shared_ptr<ElectronicStructure<Options::SCF_MODES::UNRESTRICTED> > >(spy,
               "ElectronicStructure_U",
        "@brief An unrestricted electronic structure.")
