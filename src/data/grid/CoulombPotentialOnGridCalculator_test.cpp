...
TEST_F(CoulombPotentialOnGridCalculatorTest, completeCoul_Restricted) {
  ...
  coulOnGridCalc.calculateElectronElectron<Options::SCF_MODES::RESTRICTED>(coulGrid,densMat);

  coulOnGridCalc.calculateElectronNuclei(coulGrid,atoms);
...
TEST_F(CoulombPotentialOnGridCalculatorTest, completeCoul_Unrestricted) {
  ...
  coulOnGridCalc.calculateElectronElectron<Options::SCF_MODES::UNRESTRICTED>(coulGrid,densMat);
