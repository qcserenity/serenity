...
template<Options::SCF_MODES T>class DensityOnGridCalculator;
/**
 ...
 */
template<Options::SCF_MODES T>class DensityMatrixDensityOnGridController :
    public ObjectSensitiveClass<DensityMatrix<T> >,
    public DensityOnGridController<T> {
public:
  /**
   * @brief Constructor
   * @param densOnGridCalculator A DensityOnGridCalculator to calculate the needed data. The highest available derivative is
   *                             determined by this object.
   * @param densityMatrix The density to be represented on a grid is given here in matrix form.
   */
  DensityMatrixDensityOnGridController(
