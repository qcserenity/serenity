...
TEST_F(MOCalculatorTest, MOValidate) {
   ...
   * available
   */
  CoefficientMatrix<Options::SCF_MODES::RESTRICTED> coeffs=system->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()->
...
TEST_F(MOCalculatorTest, MOValidate_Unrestricted) {
   ...
   * available
   */
  CoefficientMatrix<Options::SCF_MODES::UNRESTRICTED> coeffs=system->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()->
      getMolecularOrbitals()->getCoefficients();
