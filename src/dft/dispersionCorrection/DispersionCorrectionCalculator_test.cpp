...
class DispersionCorrectionCalculatorTest : public ::testing::Test {
 protected:
  DispersionCorrectionCalculatorTest():  systemControllerOne(
	  ...
	  systemControllerThree(
			  SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::H60_Ghost_MINBAS))
      {
...
TEST_F(DispersionCorrectionCalculatorTest, D3EnergyBP86CO) {
  double energy = DispersionCorrectionCalculator::calcDispersionEnergyCorrection(
      Options::DFT_DISPERSION_CORRECTIONS::D3,
      systemControllerOne->getGeometry(),
      Options::XCFUNCTIONALS::BP86);
...
TEST_F(DispersionCorrectionCalculatorTest, D3ABCEnergyBP86CO) {
  double energy = DispersionCorrectionCalculator::calcDispersionEnergyCorrection(
      Options::DFT_DISPERSION_CORRECTIONS::D3ABC,
      systemControllerOne->getGeometry(),
      Options::XCFUNCTIONALS::BP86);
...
TEST_F(DispersionCorrectionCalculatorTest, D3BJEnergyBP86CO) {
  double energy = DispersionCorrectionCalculator::calcDispersionEnergyCorrection(
      Options::DFT_DISPERSION_CORRECTIONS::D3BJ,
      systemControllerOne->getGeometry(),
      Options::XCFUNCTIONALS::BP86);
...
TEST_F(DispersionCorrectionCalculatorTest, D3BJABCEnergyBP86CO) {
  double energy = DispersionCorrectionCalculator::calcDispersionEnergyCorrection(
      Options::DFT_DISPERSION_CORRECTIONS::D3BJABC,
      systemControllerOne->getGeometry(),
      Options::XCFUNCTIONALS::BP86);
...
TEST_F(DispersionCorrectionCalculatorTest, NoneHessBP86CO) {
  auto hess = DispersionCorrectionCalculator::calcDispersionHessianCorrection(
      Options::DFT_DISPERSION_CORRECTIONS::NONE,
      systemControllerOne->getGeometry(),
      Options::XCFUNCTIONALS::BP86);
