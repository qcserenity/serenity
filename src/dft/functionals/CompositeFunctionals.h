...
constexpr std::array<IMPLEMENTATIONS, 57> getImplementation{
    ...
    IMPLEMENTATIONS::XCFUN /* 45 */,     IMPLEMENTATIONS::XCFUN /* 46 */,     IMPLEMENTATIONS::XCFUN /* 47 */,
    IMPLEMENTATIONS::EITHER_OR /* 48 */, IMPLEMENTATIONS::EITHER_OR /* 49 */, IMPLEMENTATIONS::EITHER_OR /* 50 */,
    IMPLEMENTATIONS::LIBXC /* 51 */,     IMPLEMENTATIONS::LIBXC /* 52 */,     IMPLEMENTATIONS::LIBXC /* 53 */,
    IMPLEMENTATIONS::LIBXC /* 54 */,     IMPLEMENTATIONS::LIBXC /* 55 */,     IMPLEMENTATIONS::EITHER_OR /* 56 */,
};
