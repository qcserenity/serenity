...
const std::map<ENERGY_CONTRIBUTIONS, EnergyContributionChildren>
        EnergyComponentPrinter::ENERGY_CONTRIBUTIONS_CHILDREN_MAP = {
  {ENERGY_CONTRIBUTIONS::ELECTRON_KINETIC, {}},
  {ENERGY_CONTRIBUTIONS::ELECTRON_ECP, {}},
  {ENERGY_CONTRIBUTIONS::ELECTRON_NUCLEUS_COULOMB, {}},
  {ENERGY_CONTRIBUTIONS::ELECTRON_ELECTRON_COULOMB, {}},
...
const std::map<ENERGY_CONTRIBUTIONS, EnergyContributionParents>
        EnergyComponentPrinter::ENERGY_CONTRIBUTIONS_PARENTS_MAP = determineEnergyContributionParentMap();

const std::map<ENERGY_CONTRIBUTIONS, std::string>
        EnergyComponentPrinter::_energyContributionMap = {
  ...
  {ENERGY_CONTRIBUTIONS::KS_DFT_EXCHANGE_CORRELATION_NO_HF,   "Exchange-Correlation Energy (without HF/MP2 contributions):"},
  ...
  {ENERGY_CONTRIBUTIONS::FDE_NAD_EXCHANGE,                    "Non-Additive Exchange Energy (FDE):                                     "},
  {ENERGY_CONTRIBUTIONS::FDE_NAD_CORRELATION,                 "Non-Additive Correlation Energy (FDE):                                  "},
  {ENERGY_CONTRIBUTIONS::FDE_NAD_XC,                          "Non-Additive Exchange-Correlation Energy (FDE):                         "},
  {ENERGY_CONTRIBUTIONS::FDE_NAD_EXACT_EXCHANGE,              "Non-Additive Exact Exchange Energy (FDE):                               "},
  ...
  {ENERGY_CONTRIBUTIONS::FDE_ELECTRONS_ENV_ELECTRONS_COULOMB, "Electrostatic Interactions of Electrons with Electrons of the Env (FDE):"},
  {ENERGY_CONTRIBUTIONS::FDE_ELECTRONS_ENV_NUCLEI_COULOMB,    "Electrostatic Interactions of Electrons with Nuclei of the Env (FDE):   "},
  {ENERGY_CONTRIBUTIONS::FDE_NUCLEI_ENV_ELECTRONS_COULOMB,    "Electrostatic Interactions of Nuclei with Electrons of the Env (FDE):   "},
  {ENERGY_CONTRIBUTIONS::FDE_NUCLEI_ENV_NUCLEI_COULOMB,       "Electrostatic Interactions of Nuclei with Nuclei of the Env (FDE):      "},
  {ENERGY_CONTRIBUTIONS::FDE_ELECTROSTATIC_INTERACTIONS,      "Total Electrostatic Interactions (FDE):                                 "},
  {ENERGY_CONTRIBUTIONS::FDE_ECP_ENV_ENERGY,                  "ECP Interaction Energy (FDE):                                           "},
  {ENERGY_CONTRIBUTIONS::FDE_INTERACTION_ENERGY,              "Total Interaction Energy (FDE):                                         "},
  {ENERGY_CONTRIBUTIONS::FDE_EMBEDDED_KS_DFT_ENERGY,          "Total Energy (embedded DFT):                                            "},
  {ENERGY_CONTRIBUTIONS::FDE_SUPERSYSTEM_ENERGY_DFT_DFT,      "Total Supersystem Energy (active + all env.):                           "},
  {ENERGY_CONTRIBUTIONS::FDE_SUPERSYSTEM_ENERGY_WF_DFT,       "Total Supersystem Energy (active + all env.):                           "},
  {ENERGY_CONTRIBUTIONS::FDE_FROZEN_SUBSYSTEM_ENERGIES,       "Total Frozen Subsystem Energies (environment):                          "},
  {ENERGY_CONTRIBUTIONS::PBE_LINEAR_CORRECTION,               "Linear Correction to the PBE energy:                                    "},
  {ENERGY_CONTRIBUTIONS::PBE_SUPERSYSTEM_ENERGY_WFT_DFT,      "Total Supersystem Energy (act. HF + env. DFT/HF):                       "},
  {ENERGY_CONTRIBUTIONS::PBE_SUPERSYSTEM_ENERGY_DFT_DFT,      "Total Supersystem Energy (act. DFT + env. DFT/HF):                      "},
  {ENERGY_CONTRIBUTIONS::MP2_CORRECTION,                      "MP2 Energy Correction:                                                  "},
  {ENERGY_CONTRIBUTIONS::CCSD_CORRECTION,                     "CCSD Energy Correction:                                                 "},
  {ENERGY_CONTRIBUTIONS::TRIPLES_CORRECTION,                  "CCSD(T) Triples Energy Correction:                                      "},
  {ENERGY_CONTRIBUTIONS::MP2_TOTAL_ENERGY,                    "Total MP2 Energy:                                                       "},
  {ENERGY_CONTRIBUTIONS::CCSD_TOTAL_ENERGY,                   "Total CCSD Energy:                                                      "},
  {ENERGY_CONTRIBUTIONS::CCSD_T_TOTAL_ENERGY,                 "Total CCSD(T) Energy:                                                   "},
};

void EnergyComponentPrinter::printEnergyComponent(
        const std::pair<ENERGY_CONTRIBUTIONS,double>& dataToPrint) {
  printf ("%-80s %18.10f \n", _energyContributionMap.at(dataToPrint.first).c_str(),dataToPrint.second);
}

const std::map<ENERGY_CONTRIBUTIONS, EnergyContributionParents>
     EnergyComponentPrinter::determineEnergyContributionParentMap() {
...
bool EnergyComponentPrinter::isAncestorOf(
  ...
  for (const auto& child : ENERGY_CONTRIBUTIONS_CHILDREN_MAP.at(ancestor)) {
    if (child == descendant || isAncestorOf(descendant, child)) return true;
  }
  return false;
}
