...
enum class ENERGY_CONTRIBUTIONS {
  ...
  FDE_SOLV_SCALED_NAD_EXCHANGE = 319,
  FDE_SOLV_SCALED_NAD_CORRELATION = 320,
  FDE_SOLV_SCALED_NAD_XC = 321,
  FDE_SOLV_SCALED_NAD_EXACT_EXCHANGE = 322,
  FDE_SOLV_SCALED_NAD_KINETIC = 323,
  FDE_SOLV_SCALED_NAD_DISP = 324,
  FDE_SOLV_SCALED_NUCLEI_ENV_ELECTRONS_COULOMB = 325,
  FDE_SOLV_SCALED_NUCLEI_ENV_NUCLEI_COULOMB = 326,
  FDE_SOLV_SCALED_ELECTRONS_ENV_ELECTRONS_COULOMB = 327,
  FDE_SOLV_SCALED_ELECTRONS_ENV_NUCLEI_COULOMB = 328,
  FDE_SOLV_SCALED_ELECTROSTATIC_INTERACTIONS = 329,
  FDE_SOLV_SCALED_INTERACTION_ENERGY = 330,
  FDE_SOLV_SCALED_EMBEDDED_KS_DFT_ENERGY = 331,
  FDE_SOLV_SCALED_EMBEDDED_HF_ENERGY = 332,
