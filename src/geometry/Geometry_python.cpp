...
void export_Geometry(py::module &spy) {
  py::class_<Geometry, std::shared_ptr<Geometry> >(spy,"Geometry",
    ...
    .def("getNAtoms", &Geometry::getNAtoms,
