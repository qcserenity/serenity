...
TEST(CoreCoreRepulsionDerivativeTest, CalculateDerivative) {
  std::shared_ptr<AtomType> atomtypeOne( new AtomType (std::string("H"),1,1.0,1.0,1.0,{}));
  std::shared_ptr<AtomType> atomtypeTwo( new AtomType (std::string("He"),2,1.0,1.0,1.0,{}));
