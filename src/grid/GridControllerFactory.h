...
class GridControllerFactory :
    public RememberingFactory<
      ...
      Options::GRID_TYPES,
      unsigned int,
      Options::RADIAL_GRID_TYPES,
      Options::SPHERICAL_GRID_TYPES,
      unsigned int,
      double> {
private:
  /**
...
public:
   ...
   */
  static std::shared_ptr<AtomCenteredGridController> produce(
...
private:
  std::unique_ptr<AtomCenteredGridController> produceNew(
      ...
      Options::SPHERICAL_GRID_TYPES sphericalGridType,
      unsigned int gridAccuracy,
      double gridWeightThreshold) override final;
