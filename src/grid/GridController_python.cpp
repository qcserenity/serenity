...
namespace py = pybind11;
  ...
  static std::shared_ptr<GridController> createGridControllerPtr1(std::vector<double> x,
                                                           std::vector<double> y,
                                                           std::vector<double> z,
                                                           std::vector<double> w){
  ...
  static std::shared_ptr<GridController> createGridControllerPtr2(std::vector<double> x,
                                                           std::vector<double> y,
                                                           std::vector<double> z){
    assert(x.size()==y.size()); 
    assert(x.size()==z.size()); 
