...
Eigen::MatrixXd comp2c1b1(std::shared_ptr<Libint> libint,
                         libint2::Operator op,
...
Eigen::MatrixXd comp2c1b2(std::shared_ptr<Libint> libint,
                         libint2::Operator op,
                         std::shared_ptr<BasisController> basis){
  return libint->compute1eInts(op,basis);
}

Eigen::MatrixXd comp2c2b1(std::shared_ptr<Libint> libint,
                         libint2::Operator op,
...
Eigen::MatrixXd comp2c2b2(std::shared_ptr<Libint> libint,
                         libint2::Operator op,
                         std::shared_ptr<BasisController> basis1,
                         std::shared_ptr<BasisController> basis2){
