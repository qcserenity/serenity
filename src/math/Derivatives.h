...
struct Gradient {
  ...
  public:
    ...
    inline iterator operator++() { iterator i(ptr); ++ptr; return i; }
...
//    inline bool operator==(const iterator& other) { return ptr == other.ptr; }
  ...
  public:
    ...
    inline const_iterator operator++() { const_iterator i(ptr); ++ptr; return i; }
...
//    inline bool operator==(const const_iterator& other) { return ptr == other.ptr; }
  ...
  inline const const_iterator begin() const { return const_iterator(&x); }
  inline iterator begin() { return iterator(&x); }
  inline const const_iterator end() const { return const_iterator(&z+1); }
  inline iterator end() { return iterator(&z+1); }
...
inline std::unique_ptr<Gradient<T> > makeGradientPtr(Args&&... args) {
  return std::unique_ptr<Gradient<T> >(new Gradient<T>{
...
//    inline bool operator==(const const_iterator& other) { return ptr == other.ptr; }
  ...
  inline const const_iterator begin() const { return const_iterator(&xx); }
  inline iterator begin() { return iterator(&xx); }
  inline const const_iterator end() const { return const_iterator(&zz+1); }
  inline iterator end() { return iterator(&zz+1); }
...
inline std::unique_ptr<Hessian<T> > makeHessianPtr(Args&&... args) {
  return std::unique_ptr<Hessian<T> >(new Hessian<T>{
    T(args...), T(args...), T(args...), T(args...), T(args...), T(args...) });
// Perfect forwarding does not work, obviously because the args are used more than once.
//    std::forward<Args>(args)..., std::forward<Args>(args)..., std::forward<Args>(args)...,
//    std::forward<Args>(args)..., std::forward<Args>(args)..., std::forward<Args>(args)...});
}
