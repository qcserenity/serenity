 ...
 *
 * @brief Contains general simple functions for floating point numbers
 *
 * which are not provided by standard libraries.
 * @copyright \n
...
/**
 * @brief own pow with unsigned int as exponent, i.e. base**pow
 *
