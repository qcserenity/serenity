...
TEST_F(QSTTest, LSTQST_Function) {
  ...
  auto _getData=[&_value,&_parameters](const Eigen::VectorXd& parameters,
       double& value,
    ...
    (void) dontcare;
     ...
     params << 1.70, 1.70,  0.80,  0.80, -1.00, -0.25, -0.25, -0.50,
               1.50, 1.50,  4.00,  4.00,  8.00,  2.00,  2.00,  4.00,
              -0.25, 1.75, -0.10,  1.60,  0.55, -0.75,  2.25,  0.75,
               4.00, 4.00,  4.00,  4.00,  2.00,  4.00,  4.00,  4.00,
               0.50, 0.50, -0.95, -0.95, -0.75, -0.75, -0.75,  1.20;
     value=0.0;
     gradients.setZero();
     for (int i=0; i<8; i++){
       const double tmp=params(0,i)*exp(-params(1,i)*(parameters[0]-params(2,i))*(parameters[0]-params(2,i))
