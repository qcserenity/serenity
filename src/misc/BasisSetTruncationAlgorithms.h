 ...
 * not truncated.
 * Make sure that your system has dummy atoms. Otherwise calling methods of this class is point less.
 *
 ...
 *   Keeps the <truncationFactor> most important basis functions of the environment. Truncation criterion for basis function \f$ \chi_j^B \f$:\n
 *   \f$ q_j = D^A_{jj}S^A_{jj} \f$\n\n
 *
 */
...
private:
   ...
   */
  inline void buildTruncatedBasis(
   ...
   */
  Eigen::VectorXi netPopulationTruncation(
   ...
   */
  Eigen::VectorXi primitiveNetPopTruncation(
      const DensityMatrix<Options::SCF_MODES::RESTRICTED> dMatActiveSystem,
