 ...
 */
constexpr std::array<char,20> ANGMOM_TO_LABEL = {{'s','p','d','f','g','h','i','k','m','n',
                                                  'o','q','r','t','u','v','w','x','y','z'}};
/**
 ...
 * https://physics.nist.gov/constants (18.07.2019)                         *
 ***************************************************************************/
/*
 * Natural Constants
 */
...
constexpr double BOHR = 5.29177210903E-011;
...
constexpr double HARTREE_TO_J = 4.359744650E-18;
/// HARTREE_TO_NM / inHartree = inNanoMetre
constexpr double HARTREE_TO_NM = 45.56337117;
/// inHartree * HARTREE_TO_OOCM = inWaveNumber
constexpr double HARTREE_TO_OOCM = 219474.63;
...
/* Dipole moment */
constexpr double AU_TO_COULOMB_METER = 8.478353552E-30; // = AU_TO_COULOMB*BOHR_TO_ANGSTROM*1e-10
/*
