...
#ifndef LRSCF_DELTAESIGMAVECTOR
#define LRSCF_DELTAESIGMAVECTOR
...
namespace Serenity {
/**
 * @class DeltaESigmaVector DeltaESigmaVector.h
 * @brief Performs the calculation of the delta energy sigma vectors
 */
template<Options::SCF_MODES SCFMode>
class DeltaESigmaVector : public SigmaVector<SCFMode> {
 public:
  /**
   * @brief Constructor
   ...
   */
  DeltaESigmaVector(std::vector<std::shared_ptr<LRSCFController<SCFMode>>> lrscf, std::vector<Eigen::MatrixXd> b,
...
}; // class DeltaESigmaVector
} // namespace Serenity

#endif /* LRSCF_DELTAESIGMAVECTOR */
