...
/**
 * @class XWFSigmaCalculator
 * @brief Used to perform nonlinear matrix--vector multiplications for ADC(2)/CC2.
 */
using XWFSigmaCalculator =
    std::function<std::unique_ptr<Eigen::MatrixXd>(Eigen::Ref<Eigen::MatrixXd> guessVectors, Eigen::VectorXd eigenvalues)>;
