...
public:
   ...
   */
  static std::shared_ptr<ABEmbeddedBundle<SCFMode> > produce(
...
private:
   ...
   */
  std::unique_ptr<ABEmbeddedBundle<SCFMode> > produceNew(
      std::shared_ptr<SystemController> activeSystem,
      std::shared_ptr<BasisController> basisControllerB,
      std::shared_ptr<Geometry> geometryB,
      std::vector<std::shared_ptr<SystemController> > environmentSystems,
  ...
  getNotProjectedEnvironmentDensityMatrixControllers(
      std::shared_ptr<SystemController> activeSystem,
      std::vector<std::shared_ptr<SystemController> > environmentSystems,
   ...
   */
  std::shared_ptr<BasisController> getABAuxBasisController(
      std::shared_ptr<SystemController> activeSystem,
      std::shared_ptr<Geometry> geometryB);
};
