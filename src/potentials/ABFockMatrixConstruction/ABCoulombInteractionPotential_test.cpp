...
protected:
  ABCoulombInteractionPotentialTest(): systemControllerA(
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_NORI_rFockMatrixABC) {
  ...
  std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED> > > envDmat(1,
      systemControllerC->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_NORI_uFockMatrixABC) {
  ...
  std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED> > > envDmat(1,
      systemControllerC->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()
      ->getDensityMatrixController());

  ABCoulombInteractionPotential<Options::SCF_MODES::UNRESTRICTED> abCoulIntPot(
      systemControllerA,
      basisA,
      basisB,
      envDmat);
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_NORI_rFockMatrixAAB) {
  ...
  auto basisA = systemControllerA->getBasisController();
  std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED> > > envDmat(1,
      systemControllerB->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
      ->getDensityMatrixController());
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_NORI_rFockMatrixCCC) {
  ...
  HFPotential<Options::SCF_MODES::RESTRICTED> hfPotential(
      systemControllerC,
      envDmat[0],
      0.0,
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_RI_rFockMatrixABC) {
  ...
  *joinedGeometry += *systemControllerB->getGeometry();
  ...
  std::shared_ptr<BasisController> actAuxBasis = AtomCenteredBasisControllerFactory::produce(
      joinedGeometry,
      systemControllerA->getSettings().basis.basisLibPath,
      systemControllerA->getSettings().basis.makeSphericalBasis,
      false,
      systemControllerA->getSettings().basis.firstECP,
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_RI_rFockMatrixACC) {
  ...
  *joinedGeometry += *systemControllerC->getGeometry();
  ...
  ABCoulombInteractionPotential<Options::SCF_MODES::RESTRICTED> abCoulIntPot_NORI(
      systemControllerA,
      basisA,
      basisC,
      envDmat);
...
TEST_F(ABCoulombInteractionPotentialTest, H2_dimer_RI_uFockMatrixACC) {
  ...
  auto basisA = systemControllerA->getBasisController();
  auto basisC = systemControllerC->getBasisController();
  std::vector<std::shared_ptr<DensityMatrixController<SPIN> > > envDmat(1,
      systemControllerC->getElectronicStructure<SPIN>()
      ->getDensityMatrixController());
  ...
  *joinedGeometry += *systemControllerC->getGeometry();
  ...
  ABCoulombInteractionPotential<SPIN> abCoulIntPot_NORI(
      systemControllerA,
      basisA,
      basisC,
      envDmat);
