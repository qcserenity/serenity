 ...
 */
#ifndef POTENTIALS_ABFOCKMATRIXCONSTRUCTION_ABEXCHANGEPOTENTIAL_H_
#define POTENTIALS_ABFOCKMATRIXCONSTRUCTION_ABEXCHANGEPOTENTIAL_H_
...
/**
 * @class ABExchangePotential ABExchangePotential.h
 * @brief Calculates the exchange contribution to a AB Fock matrix.
 *
...
class ABExchangePotential : public ABPotential<SCFMode>,
 ...
 public:
   ...
   */
  ABExchangePotential(std::shared_ptr<SystemController> actSystem, std::shared_ptr<BasisController> basisA,
                      std::shared_ptr<BasisController> basisB,
                      std::vector<std::shared_ptr<DensityMatrixController<SCFMode>>> dMats, double exchangeRatio);

  virtual ~ABExchangePotential() = default;
...
#endif /* POTENTIALS_ABFOCKMATRIXCONSTRUCTION_ABEXCHANGEPOTENTIAL_H_ */
