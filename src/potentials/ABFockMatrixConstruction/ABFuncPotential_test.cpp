...
protected:
  ABFuncPotentialTest(): systemControllerA(
...
TEST_F(ABFuncPotentialTest, H2_FockMatrixAA_LDA) {
  ...
  std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED>> dMat = systemControllerA
...
TEST_F(ABFuncPotentialTest, H2_uFockMatrixAB_GGA) {
  ...
  std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED>> dMat = systemControllerA
