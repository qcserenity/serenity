...
namespace Serenity {
class ABHFPotentialTest : public ::testing::Test {
protected:
  ABHFPotentialTest(): systemControllerA(
  ...
  virtual ~ABHFPotentialTest() = default;
 ...
 */
TEST_F(ABHFPotentialTest, H2_dimer_rFockMatrixAA) {
  ...
  HFPotential<SPIN> hfPotential(
      systemControllerA,systemControllerA->getElectronicStructure<SPIN>()->getDensityMatrixController(),1.0,1E-10);
 ...
 */
TEST_F(ABHFPotentialTest, H2_dimer_rFockMatrixAB) {
