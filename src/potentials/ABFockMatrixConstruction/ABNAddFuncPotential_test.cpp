...
protected:
  ABNAddFuncPotentialTest(): systemControllerA(
...
TEST_F(ABNAddFuncPotentialTest, H2_dimer_rFockMatrixAAB_LDA) {
  ...
  ABNAddFuncPotential<Options::SCF_MODES::RESTRICTED> abNAddPot(
      ...
      basisA,
      envDmat,
      systemControllerA->getGridController(),
...
TEST_F(ABNAddFuncPotentialTest, H2_dimer_rFockMatrixABBB_GGA) {
  ...
  auto basisA = systemControllerA->getBasisController();
  auto basisB = systemControllerB->getBasisController();
  std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED> > > envDmat(2,
      systemControllerB->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
      ->getDensityMatrixController());
...
TEST_F(ABNAddFuncPotentialTest, H2_dimer_uFockMatrixABB_GGA) {
  ...
  std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED> > > envDmat(1,
      systemControllerB->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()
      ->getDensityMatrixController());
