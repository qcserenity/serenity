...
TEST_F(BUReconstructionPotentialTest, H2FDE) {
  ...
  *superSystemGeometry+=*(_environmentSystem->getGeometry());
  ...
  auto supersystemGrid = GridControllerFactory::produce(
        superSystemGeometry, _activeSystem->getSettings(), Options::GRID_PURPOSES::DEFAULT);

  BUReconstructionPotential<Options::SCF_MODES::RESTRICTED> exactNaddKin(_activeSystem,
      _activeSystem->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()->getDensityMatrixController(),
      {_environmentSystem->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()->getDensityMatrixController()},
      supersystemGrid,
      FunctionalClassResolver::resolveFunctional(Options::FUNCTIONALS::PBE0),
      {_environmentSystem},
      1e-4,
      "AUG-CC-PVQZ",
      1e-4,
  ...
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.energies.res.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.orbs.res.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.dmat.res.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.settings").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.xyz").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE").c_str());
...
TEST_F(BUReconstructionPotentialTest, H2FDEUnres) {
  ...
  *superSystemGeometry+=*(_environmentSystem->getGeometry());
  ...
  BUReconstructionPotential<Options::SCF_MODES::UNRESTRICTED> exactNaddKin(_activeSystem,
      _activeSystem->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()->getDensityMatrixController(),
  ...
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.energies.unres.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.orbs.unres.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.dmat.unres.h5").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.settings").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE/TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE.xyz").c_str());
  std::remove((_activeSystem->getSettings().path+"TestSystem_H2_6_31Gs_ACTIVE_FDE+TestSystem_H2_6_31Gs_ENVIRONMENT_FDE").c_str());
