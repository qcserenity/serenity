/**
 * @file CoulombPotential_test.cpp
 *
 * @date Dec 1, 2016
 * @author: Kevin Klahr
 * @copyright \n
...
class CoulombPotentialTest : public ::testing::Test {
protected:
  CoulombPotentialTest(): systemController(
      SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::H2_DEF2_TZVP)){
	}

	virtual ~CoulombPotentialTest() = default;
...
/**
 * @test CoulombPotentialTest
 * @brief Tests the Fock Matrix of an H2
 */
TEST_F(CoulombPotentialTest, H2_rFockMatrix) {
  ...
  CoulombPotential<Options::SCF_MODES::RESTRICTED> coulPot(systemController,dMat,ri_j_IntController,1E-10);
 ...
 * @brief Tests the Fock Matrix of an H2
 */
TEST_F(CoulombPotentialTest, H2_uFockMatrix) {
  ...
  CoulombPotential<Options::SCF_MODES::UNRESTRICTED> coulPot(systemController,dMat,ri_j_IntController,1E-10);
 ...
 */
TEST_F(CoulombPotentialTest, H2_rGradients) {
 ...
 * @brief Tests the gradient of an H2
 */
TEST_F(CoulombPotentialTest, H2_uGradients) {
