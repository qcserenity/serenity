...
protected:
        ExchangeInteractionPotentialTest(): systemControllerAct(
                                                ...
                                                SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::H2_6_31Gs_ENVIRONMENT_FDE)),
                                                                systemControllerWater(
                                                SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::WATER_DISTORTED_MINBAS))                                            {
        }
...
TEST_F(ExchangeInteractionPotentialTest, H2_dimer_FockMatrix_Restricted) {
        ...
        auto basis = systemControllerAct->getAtomCenteredBasisController();
          ...
          std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED>> dMat = systemControllerAct
              ->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
              ->getDensityMatrixController();

          HFPotential<Options::SCF_MODES::RESTRICTED> coulPot(systemControllerAct,dMat,1.0,1E-10);
          ...
          CoulombInteractionPotential<Options::SCF_MODES::RESTRICTED> potential3(systemControllerAct,{systemControllerEnv},basis,dMatAct);
...
TEST_F(ExchangeInteractionPotentialTest, H2_dimer_FockMatrix_Unrestricted) {
        ...
        auto basis = systemControllerAct->getAtomCenteredBasisController();
          ...
          std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED>> dMat = systemControllerAct
              ->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()
              ->getDensityMatrixController();

          HFPotential<Options::SCF_MODES::UNRESTRICTED> coulPot(systemControllerAct,dMat,1.0,1E-10);
          ...
          dMatAct.push_back(systemControllerAct->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()->getDensityMatrixController());

          ExchangeInteractionPotential<Options::SCF_MODES::UNRESTRICTED> potential2(basis,dMatAct,1.0,1E-10);
          CoulombInteractionPotential<Options::SCF_MODES::UNRESTRICTED> potential3(systemControllerAct,{systemControllerEnv},basis,dMatAct);
...
TEST_F(ExchangeInteractionPotentialTest, H2O_FockMatrix) {
        ...
        auto basis = systemControllerWater->getAtomCenteredBasisController();
          ...
          std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED>> dMat = systemControllerWater
              ->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
              ->getDensityMatrixController();

          HFPotential<Options::SCF_MODES::RESTRICTED> coulPot(systemControllerWater,dMat,1.0,1E-10);

          FockMatrix<Options::SCF_MODES::RESTRICTED> FNoInt = coulPot.getMatrix();

          std::vector<std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED> > >dMatAct;
          dMatAct.push_back(systemControllerWater->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()->getDensityMatrixController());
