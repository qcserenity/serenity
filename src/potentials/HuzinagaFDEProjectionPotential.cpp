...
template<Options::SCF_MODES SCFMode>
SPMatrix<SCFMode> HuzinagaFDEProjectionPotential<SCFMode>::buildOuterDiagonalFockMatrix(unsigned int iEnv) {
...
template<Options::SCF_MODES SCFMode>
std::shared_ptr<EmbeddingSettings> HuzinagaFDEProjectionPotential<SCFMode>::adjustSettings(EmbeddingSettings& settings) {
