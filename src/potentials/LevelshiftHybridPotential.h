...
template<Options::SCF_MODES T> class LevelshiftPotential;
template<Options::SCF_MODES T> class NAddFuncPotential;
 ...
 *        arbitrary number of environment systems and is able to use a hybrid method of level-shift and non-additive kinetic
 *        energy functional.
 */
...
public:
   ...
   * @param basisFunctionRatio     (optional) The basis function ratio of kept basis functions. Determination of distant atoms.
   *                               (needs isHybrid = true)
  ...
  LevelshiftHybridPotential(
      ...
      std::shared_ptr<GridController> grid = nullptr,
      Functional functional = FunctionalClassResolver::resolveFunctional(
          Options::KINFUNCTIONALS::LLP91K),
