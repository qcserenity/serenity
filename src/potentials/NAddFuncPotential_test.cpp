...
protected:
	NAddFuncPotentialTest(): systemControllerAct(
...
TEST_F(NAddFuncPotentialTest, H2Dimer_FockMatrix_LDA) {
	...
	std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED>> dMatAct = systemControllerAct
			->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
			->getDensityMatrixController();
	std::shared_ptr<DensityMatrixController<Options::SCF_MODES::RESTRICTED>> dMatEnv = systemControllerEnv
			->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()
			->getDensityMatrixController();
	...
	NAddFuncPotential<Options::SCF_MODES::RESTRICTED> NAddPot(systemControllerAct,
				  	  	  	  	  	  	  	  	  	  	  	  dMatAct,
															  dMatsEnv,
															  grid,
...
TEST_F(NAddFuncPotentialTest, H2Dimer_FockMatrix_LDA_UNRES) {
  ...
  std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED>> dMatAct = systemControllerAct
      ->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()
      ->getDensityMatrixController();
  std::shared_ptr<DensityMatrixController<Options::SCF_MODES::UNRESTRICTED>> dMatEnv = systemControllerEnv
      ->getElectronicStructure<Options::SCF_MODES::UNRESTRICTED>()
      ->getDensityMatrixController();
  ...
  NAddFuncPotential<Options::SCF_MODES::UNRESTRICTED> NAddPot(systemControllerAct,
                                                      dMatAct,
                                dMatsEnv,
                                grid,
                                FunctionalClassResolver::resolveFunctional(Options::FUNCTIONALS::LDA));
...
TEST_F(NAddFuncPotentialTest, H2Dimer_FockMatrix_GGA) {
  ...
  NAddFuncPotential<Options::SCF_MODES::RESTRICTED> NAddPotGGA(systemControllerAct,
      dMatAct,
      dMatsEnv,
      grid,
...
TEST_F(NAddFuncPotentialTest, H2Dimer_FockMatrix_GGA_UNRES) {
  ...
  NAddFuncPotential<Options::SCF_MODES::UNRESTRICTED> NAddPotGGA(systemControllerAct,
      dMatAct,
      dMatsEnv,
      grid,
      FunctionalClassResolver::resolveFunctional(Options::FUNCTIONALS::BP86));
