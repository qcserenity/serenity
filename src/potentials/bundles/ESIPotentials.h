 ...
 *  - the Coulomb repusion between the active electrons and all environment electrons
...
public:
   ...
   * @brief Constructor.
   * 
   * This contructor builds a version of the Potential that does not use the RI approximation.
   * The DensityMatrix and Geometry arguments in addtiion to the systems
   ...
   *            and all environment orbitals. The implementation does NOT solve Loewdins 
   *            general formula for non-orthogonal molecular orbitals.
   * 
   * @param actSystem  The single active system all other systems act upon.
   * @param envSystems The environemnt systems that are to be coupled to the active system. 
   * @param activeDMat The DensityMatrix of the active system.
   * @param activeGeom The Geometry of the active system.
   * @param envDMats   The DensityMatrices of the environemnt systems. 
   * @param envGeoms   The geometries of the environemnt systems. 
   * @param excFac     A factor to add some exact exchange interaction.
   */
  ESIPotentials(std::shared_ptr<SystemController> actSystem,
                ...
                std::vector<std::shared_ptr<const Geometry> > envGeoms);

  /**
   * @brief Constructor
   * 
   * This contructor builds a version of the Potential that uses the RI approximation.
   * The DensityMatrix, auxilliary basis and Geometry arguments in addtiion to the systems
   * are required to allow for custom matrices etc. that are not stored in the 
   * systems.
   * 
   * With this contructor it is not possible to add an exact exchange interaction part.
   * 
   * @param actSystem   The single active system all other systems act upon.
   * @param envSystems  The environemnt systems that are to be coupled to the active system. 
   * @param activeDMat  The DensityMatrix of the active system.
   ...
   * @param envDMats    The DensityMatrices of the environemnt systems. 
   * @param envGeoms    The geometries of the environemnt systems. 
   * @param actAuxBasis The auxilliary basis set of the active system.
   * @param envAuxBasis The auxilliary basis sets of the environment systems.
   */
  ESIPotentials(std::shared_ptr<SystemController> actSystem,
      std::vector<std::shared_ptr<SystemController> > envSystems,
      std::shared_ptr<DensityMatrixController<SCFMode> > activeDMat,
