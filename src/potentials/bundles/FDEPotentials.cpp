...
FDEPotentials<SCFMode>::FDEPotentials(
    std::shared_ptr<PotentialBundle<SCFMode> >activeSystemPot,
...
FDEPotentials<SCFMode>::getFockMatrix(const DensityMatrix<SCFMode>& P,
