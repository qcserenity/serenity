...
std::shared_ptr<SystemController> add(std::shared_ptr<SystemController> sys1,
    ...
    system->setElectronicStructure(
        std::shared_ptr<ElectronicStructure<Options::SCF_MODES::RESTRICTED> >(
            InitialGuessFactory::produce<Options::SCF_MODES::RESTRICTED>(
                system->getSettings().scf.initialguess)
...
void export_SystemController(py::module &spy) {
    ...
    py::class_<SystemController, std::shared_ptr<SystemController> >(spy,"System")
        .def(py::init(&createSystemControllerPtr1),
             "@brief The basic constructor for a system\n"
             "\n"
        ...
        .def("getBasis",&SystemController::getBasisController,
               py::arg("basisPurpose") = Options::BASIS_PURPOSES::DEFAULT)
        .def("getGrid",&SystemController::getGridController,
               py::arg("gridPurpose") = Options::GRID_PURPOSES::DEFAULT)
