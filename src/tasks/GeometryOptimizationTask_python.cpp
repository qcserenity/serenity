...
void export_GeometryOptimizationTask(py::module &spy){
  py::class_<GeometryOptimizationTaskSettings>(spy,"GeometryOptimizationTaskSettings",
      ...
      .def_readwrite("naddKinFunc",&GeometryOptimizationTaskSettings::naddKinFunc)
      .def_readwrite("naddXCFunc",&GeometryOptimizationTaskSettings::naddXCFunc)
