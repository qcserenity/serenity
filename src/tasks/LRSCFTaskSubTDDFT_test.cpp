...
TEST_F(LRSCFTaskSubTDDFTTest, sTDDFT_Level_RI) {
  auto act = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::H2_def2_SVP_ACTIVE_FDE_BP86, true);
  auto env =
      SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::H2_def2_SVP_ENVIRONMENT_FDE_BP86, true);
  auto task = TDEmbeddingTask<RESTRICTED>(act, env);
...
TEST_F(LRSCFTaskSubTDDFTTest, sTDDFT_Level_RI_Unrestricted) {
  ...
  // It was however checked that for NoRI both results are identical
...
TEST_F(LRSCFTaskSubTDDFTTest, uTDDFT_Exact_Approx_Embedding) {
  ...
  auto act1_act2 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He2_def2SVP_BP86, true);
  auto act1 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, true);
  auto act2 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_2_def2SVP_BP86, true);
  auto env3 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_3_def2SVP_BP86, true);
  ...
  auto excitationsAB = lrscfContrSeperated1->getExcitationEnergies(Options::LRSCF_TYPE::COUPLED);
  for (unsigned int iExc = 0; iExc < 10; iExc++) {
    EXPECT_NEAR((*excitationsAB)(iExc), (*excitationsABCombined)(iExc), 3.0e-5);
  }
...
TEST_F(LRSCFTaskSubTDDFTTest, uTDDFT_Exact_Approx_Embedding_VirtualOrbLocalization) {
  ...
  auto act1 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, true);
  // LE
  auto act1_LE = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, true);
  Settings settings_act_LE = act1_LE->getSettings();
  settings_act_LE.name = act1_LE->getSettings().name + "LE";
  act1_LE = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, settings_act_LE);
  // CT
  auto act1_CT = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, true);
  Settings settings_act_CT = act1_CT->getSettings();
  settings_act_CT.name = act1_CT->getSettings().name + "CT";
  act1_CT = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_1_def2SVP_BP86, settings_act_CT);
  auto act2 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_2_def2SVP_BP86, true);
  auto env3 = SystemController__TEST_SUPPLY::getSystemController(TEST_SYSTEM_CONTROLLERS::He_3_def2SVP_BP86, true);
  ...
  for (unsigned int iExc = 0; iExc < (*excitationsCouppledLocalized_A).size(); iExc++) {
    EXPECT_NEAR((*excitationsUncoupled_A)(iExc), (*excitationsCouppledLocalized_A)(iExc), 4.0e-5);
  }
