...
void export_LRSCFTask(py::module& spy) {
  py::class_<LRSCFTaskSettings>(spy, "LRSCFTaskSettings", "@brief Default constructor for Settings all set to their default values.")
      ...
      .def_readwrite("algorithm", &LRSCFTaskSettings::algorithm)
      ...
      .def_readwrite("saveResponseMatrix", &LRSCFTaskSettings::saveResponseMatrix)
      ...
      .def_readwrite("ccprops", &LRSCFTaskSettings::ccprops)
