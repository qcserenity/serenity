...
TEST_F(MP2TaskTest, MP2Restricted) {
  ...
  mp2Task.settings.ri = false;
  mp2Task.run();
  auto energyComponentController = systemController->getElectronicStructure<Options::SCF_MODES::RESTRICTED>()->getEnergyComponentController();
