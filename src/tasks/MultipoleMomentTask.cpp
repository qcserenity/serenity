...
MultipoleMomentTask<SCFMode>::MultipoleMomentTask(const std::shared_ptr<SystemController> system)
...
void MultipoleMomentTask<SCFMode>::run() {
  ...
  auto multipoleMoment =
      MultipoleMomentCalculator::calculateMultipoleMoment<SCFMode>(_systemController, settings.highestOrder);
  ...
  printf("%4s %+9.10f %+9.10f %+9.10f Debye\n\n", "", multipoleMoment[0][0] * AU_TO_DEBYE,
         multipoleMoment[0][1] * AU_TO_DEBYE, multipoleMoment[0][2] * AU_TO_DEBYE);
