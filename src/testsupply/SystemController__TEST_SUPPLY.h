...
enum class TEST_SYSTEM_CONTROLLERS { H2_MINBAS=0, H2_MINBAS_ACTIVE, H2_MINBAS_ENVIRONMENT, H2_MINBAS_LARGE_DISTANCE, H2_DEF2_TZVP, WATER_DISTORTED_MINBAS, CO_MINBAS, JACOBSEN_MINBAS,
                                     ...
                                     WaterMonTwo_6_31Gs_DFT, WaterMonOne_6_31Gs_DFT,H60_Ghost_MINBAS,OH_MINBAS_PBE,HI_Def2_SVP_PBE,I2_Def2_SVP_PBE,H2_MINBAS_LINEARDEPENDENT,
                                     H2_6_31Gs_ACTIVE_FDE_HYBRID,H2_6_31Gs_ENVIRONMENT_FDE_HYBRID};
