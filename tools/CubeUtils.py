...
def write_cubfile(fname, molecule, prop, origin=None, vox=None, incr=None, comment=None):
...
def subtractCubes(fname1,fname2,outfile):
   ...
   write_cubfile(outfile, f1.get_molecule(), diff, origin=f1.origin, vox=f1.vox, incr=f1.incr)
