...
#ifndef LRSCF_RICOULOMBSIGMAVECTOR
#define LRSCF_RICOULOMBSIGMAVECTOR
...
class RICoulombSigmavector : public Sigmavector<SCFMode> {
 public:
   ...
   */
  RICoulombSigmavector(std::vector<std::shared_ptr<LRSCFController<SCFMode>>> lrscf, std::vector<Eigen::MatrixXd> b);
   ...
   */
  RICoulombSigmavector(std::vector<std::shared_ptr<LRSCFController<SCFMode>>> lrscf);

  virtual ~RICoulombSigmavector() = default;
...
}; // class RICoulombSigmavector
} // namespace Serenity

#endif /* LRSCF_RICOULOMBSIGMAVECTOR */
