...
/**
 * @test
 * @brief Tests HuzinagaFDEProjectionPotential.h/.cpp: Tests restricted fock matrix.
 */
TEST_F(HuzinagaFDEProjectionPotentialTest, restricted_huzinaga) {
  ...
  HuzinagaFDEProjectionPotential<Options::SCF_MODES::RESTRICTED> huzFDEPotential(act, {env}, settings);
...
/**
 * @test
 * @brief Tests HuzinagaFDEProjectionPotential.h/.cpp: Tests unrestricted fock matrix.
 */
TEST_F(HuzinagaFDEProjectionPotentialTest, unrestricted_huzinaga) {
  ...
  EmbeddingSettings settings;
  settings.naddXCFunc = act->getSettings().dft.functional;
  HuzinagaFDEProjectionPotential<Options::SCF_MODES::UNRESTRICTED> huzFDEPotential(act, {env}, settings);
  auto f = huzFDEPotential.getMatrix();
...
/**
 * @test
 * @brief Tests HuzinagaFDEProjectionPotential.h/.cpp: Tests restricted fock matrix; with completely truncated projector.
 */
TEST_F(HuzinagaFDEProjectionPotentialTest, restricted_truncProjection) {
  ...
  HuzinagaFDEProjectionPotential<SPIN> huzFDEPotential(act, {env}, settings);
